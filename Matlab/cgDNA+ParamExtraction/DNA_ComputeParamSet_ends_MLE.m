...
% stepsize
stepsize =  [1e-4,5e-4, 2e-3,5e-3, 1e-1, 3e-1];
tolerance = [100,50,30, 10, 1, 1e-11];
...
filename = [ './' Opt.ProjectName  '/cgDNA+_MLE_ends' Opt.RunName '.mat' ];
