...
Opt.PathData = './Data/palin.bscl.spce.dang.60.ends.stat.mat';
...
Opt.InitGuess = './ParamSets/ps_ABC_SPCE_D_PD.mat';
...
% be computed.
Opt.activelist_end_id =  [1 3:16]; %[2]
...
filename = [ './' Opt.ProjectName '/Initial_opt.mat' ];
save(filename,'Opt') ;
