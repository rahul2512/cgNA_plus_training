...
% saved.
Opt.ProjectName = 'RNA_ends';
Opt.RunName = '4mus_ends';
...
Opt.PathData = './Data/rna.ol3.tip3p.jc.60.ends.stat.cgf.dna_form.mat';
...
Opt.InitGuess = './RNA_ends/RNA_ends_prmset_4mus_ends.mat';
