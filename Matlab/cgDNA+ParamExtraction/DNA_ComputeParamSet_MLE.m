...
if isempty(ParamSetInfo.initvalues)
    ...
    a="Using initialvalues as the initial Solution "
end
...
stepsize =  [1e-5,5e-5,5e-4, 1e-3, 3e-2, 3e-1];
tolerance = [500, 100, 50,   10,   1,    1e-11];
...
filename = [ './' Opt.ProjectName  '/cgDNA+_MLE' Opt.RunName '.mat' ];
